...
if (isset($_GET['cedula'],$_GET['pago'])) {
	session_start();
	$n_pago  = $_GET['pago'];
	$cedula  = $_GET['cedula'];
...
class PDF extends FPDF{
  function Header(){
    #$this->Image('logo.png', 11, 15, 30, 30, 'PNG');
		$this->Image('../../assets/img/logo-new.png', 11, 15, 30, 30, 'PNG');
...
$this->SetXY(50, 44.5);
    $this->MultiCell(90, 0, utf8_decode('Teléfono: 2713-2816 / 8923-6306'), 0, 'L');
     $currentdate1 = date("d");
     $currentdate2 = date("F");
     $currentdate3 = date("y");
    ...
    $this->Ln();
$this->Image('../../assets/img/logo-new.png', 159, 15, 30, 30, 'PNG');
...
$this->SetXY(198, 44.5);
  ...
  function fun(){
    ...
    $this->SetXY(11, $pixel);
    $this->MultiCell(20,5,utf8_decode($mb .' MB'),0,'C');
    $this->SetXY(31, $pixel);
    $this->MultiCell(65,5,utf8_decode($fecha ),0,'C');
    $this->SetXY(96, $pixel);
    $this->MultiCell(20,5,utf8_decode('$ '.$pago ),0,'C');
  ...
  $this->SetFont('Courier','', 10);
  $this->SetXY(32, 58);
  $this->MultiCell(100,5,utf8_decode($nombre),0,'L');
  $this->SetFont('Courier','B', 10);
  $this->SetXY(13, 63.5);
  $this->MultiCell(25,5,utf8_decode('Dirección: '),0,'L');
  $this->SetFont('Courier','', 10);
  $this->SetXY(37, 64);
  $this->MultiCell(100,4,utf8_decode($direccion.', '.$ubicacion),0,'L');
  $this->SetXY(11, 74);
...
$this->SetXY(11, 84);
$this->MultiCell(20,62,utf8_decode(''),1,'L');
$this->SetFont('Courier','B', 10);
$this->SetXY(31, 74);
$this->MultiCell(65,10,utf8_decode('Mes a pagar'),1,'C');
$this->SetXY(31, 84);
$this->MultiCell(65,62,utf8_decode(''),1,'C');
$this->SetFont('Courier','B', 10);
$this->SetXY(96, 74);
...
$this->SetXY(116, 84);
$this->MultiCell(20,62,utf8_decode(''),1,'C');
$this->SetFont('Courier','B', 10);
$this->SetXY(116, 146);
$this->MultiCell(20,8,utf8_decode('$ '.$total_pago),1,'C');
$this->SetFont('Courier','B', 10);
$this->SetXY(11, 146);
