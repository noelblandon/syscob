...
if(isset($_GET['recibo'],$_GET['nombrec'],$_GET['prod'],$_GET['vcant'],$_GET['precio'],$_GET['vdesc1'],$_GET['total'])){
  	session_start();
...
$this->SetXY(198, 44.5);
  ...
  function fun(){
    ...
    $this->SetXY(11, 84);
    $this->MultiCell(20,5,utf8_decode($_GET['vcant']),0,'C');
    $this->SetXY(31, 84);
    $this->MultiCell(65,5,utf8_decode($_GET['prod'] ),0,'L');
    $this->SetXY(96, 96);
    $this->MultiCell(20,5,utf8_decode(''),0,'C');
    $this->SetXY(116, 84);
    $this->MultiCell(20,5,utf8_decode('$ '.$_GET['precio'] ),0,'C');
    /* datos del body*/
    $this->SetFont('Courier','', 10);
    $this->SetXY(159, 84);
    $this->MultiCell(20,5,utf8_decode($_GET['vcant']),0,'C');
...
$this->SetXY(11, 48);
$this->MultiCell(35,10,utf8_decode('N° '.$_GET['recibo']),0,'L');
    $this->SetFont('Courier','',10);
    $this->SetXY(11, 58);
...
$this->SetFont('Courier','B', 10);
$this->SetXY(31, 74);
$this->MultiCell(65,10,utf8_decode('Descripción'),1,'C');
$this->SetXY(31, 84);
...
$this->SetFont('Courier','B', 10);
$this->SetXY(96, 146);
$this->MultiCell(40,8,utf8_decode('$ '.$_GET['total']),1,'R');
$this->SetFont('Courier','B', 10);
$this->SetXY(11, 146);
$this->MultiCell(20,8,utf8_decode('Total'),1,'C');
$this->SetXY(11, 141);
$this->MultiCell(125,5,utf8_decode(''),1,'R');
